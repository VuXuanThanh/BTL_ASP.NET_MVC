...
*/
    ...
    var B = /:[0-9]+$/,
        ...
        F = function (a, b) {
            ...
            "port" === b
                ? (a.port = String(Number(a.hostname ? a.port : y.location.port) || ("http" == a.protocol ? 80 : "https" == a.protocol ? 443 : "")))
...
*/
    ...
    var bd = function (a) {
        ...
        ge = function (a, b, c) {
            1 <= 100 * Math.random() ||
                G("?") ||
                ((a = ["t=error", "_e=" + a, "_v=j91", "sr=1"]), b && a.push("_f=" + b), c && a.push("_m=" + K(c.substring(0, 100))), a.push("aip=1"), a.push("z=" + hd()), wc(bd(!0) + "/u/d", a.join("&"), ua));
        };
    var qc = function () {
    ...
    var td = function (a, b) {
            ...
            if ("cookie" == P(a, ac)) {
                ...
                a.get(je) &&
                    ...
                    ef(c),
                    d && 0 != d.length && ((c = d[0]), (d = c.qa), c.labels && c.labels.length && (d += "." + c.labels.join(".")), a.data.set(Te, c.timestamp / 1e3), a.data.set(Se, d)));
            }
            if (a.get(Hd)) {
                c = be("_ga", !!a.get(cc));
